...
//DOM elementen
    ...
    let brouwerKnop = document.getElementById('btn_brouwer');
    let bierKnop = document.getElementById('btn_bier');

    let bierData = document.getElementById('bierData');

    initialisatieLijst(brouwerLijst);
    lijstUpdateHandler(brouwerKnop,brouwerLijst,bierLijst, 'brouwerNr');
    divUpdateHandler(bierKnop, bierLijst, bierData, 'bierNr');
...
function lijstUpdateHandler(btn, keuzeLijst, updateLijst, param) {
    /*
...
function divUpdateHandler(btn, keuzeLijst, updateDiv, param) {
    /*
     eventhandlers voor knoppen die een lijst moeten updaten
