define(['app/cinemas','app/films','app/makeHtml'],function(cinemas,films,Html) {
    ...
    return {
        ...
        koopModule: function() {
            ...
            this.elements.aantal = Html.makeInput({
                "id":"aantal",
                "class":"mijnInput",
                "type":"number"
            });
            this.elements.knop = Html.makeButton("Koop tickets", {
                "id":"deKnop",
                "class":"mijnKnop",
                "type":"button"
            });
        ...
        bestel: function(el) {
            //bestelfunctie
            let welkeCinema = this.elements.cinemas.val();
            let welkeFilm = this.elements.films.val();
            let aantal = this.elements.aantal.val();
